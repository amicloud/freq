...
class HistRateStrategyV10(IStrategy):
    """
    HistRateStrategyV10: Historical win-rate vs stop-loss filter with EMA slope filter.
    - minimal_roi defined as a class variable (no property)
